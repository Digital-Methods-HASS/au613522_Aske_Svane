...
crs(manhattan) <- crs_2 # multi-bound file
...
library(sf, raster)
# neighborhoods and trees and vectors 
# manhattan and canopy are rasters
...
st_crs(trees_crs) # string vector
st_crs(neighborhoods_crs) # vector
crs(manhattan_crs) # raster
crs(canopy) # raster
```
