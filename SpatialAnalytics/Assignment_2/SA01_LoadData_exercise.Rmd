...
There are eight columns which give eight pieces of information about each point


2. How many features are there inside `neighborhoods` and what is their geometry?
There are 6 columns with information. Their geometry is multipolygon


3. What is the CRS value in these objects?
The CRS value is 4326.
...
Number of rows is 230 and number of columns is 253
```{r}
